...
" The Following is a date Keybinging
	imap <F2> <C-R>=strftime("%Y,%m,%d")<CR>

" Add in Place holder functionality:
	imap <buffer> ;' <C-O>/<++><CR><C-O>c4l
	nmap <buffer> ;' /<++><CR>c4l
	imap <buffer> ;'n <C-O>/<+n+><CR><C-O>c4l<C-O>"%p
	nmap <buffer> ;'n /<+n+><CR>c4l<C-R><C-O>"%p<C-R>
	imap <buffer> ;'d <C-O>/<+d+><CR><C-O>c4l<C-R>=strftime("%Y,%m,%d")<CR>
	nmap <buffer> ;'d /<+d+><CR>c4l<C-R>=strftime("%Y,%m,%d")<CR>
